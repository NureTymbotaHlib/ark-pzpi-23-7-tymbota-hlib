 ...
 *   post:
 *     tags: [Claims]
 *     summary: Register claim (set InReview and assign manager)
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *   patch:
 *     tags: [Claims]
 *     summary: Make decision for claim (approve/reject)
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *           schema:
 *             type: object
 *             required: [manager_user_id, decision]
 *             properties:
 *               manager_user_id:
 *                 type: integer
 *                 example: 3
 ...
 *   post:
 *     tags: [Claims]
 *     summary: Mark approved claim as paid
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
